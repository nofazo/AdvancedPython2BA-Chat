...
SERVERADDRESS = (socket.gethostname(), 4500)
...
class ServerClient(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            # On va ajouter les adresses des clients dans le dictionnaire créé plus haut
    ...
    def _help(self, client):
        ...
        client.send('/clients ====> Donne la liste des clients\n /quitter ====> Ferme la connexion avec le server'.encode())
